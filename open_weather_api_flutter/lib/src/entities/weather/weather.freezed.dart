...
class _$_WeatherParams implements _WeatherParams {
  ...
  @override
  String toString() {
    return 'WeatherParams(temp: $temp, feelLike: $feelLike, tempMin: $tempMin, tempMax: $tempMax)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.feelLike, feelLike) &&
...
/// @nodoc
class _$WeatherCoordTearOff {
  const _$WeatherCoordTearOff();

  _WeatherCoord call({required double lat, required double lon}) {
    return _WeatherCoord(
      lat: lat,
      lon: lon,
    );
  }

  WeatherCoord fromJson(Map<String, Object?> json) {
    return WeatherCoord.fromJson(json);
  }
}

/// @nodoc
const $WeatherCoord = _$WeatherCoordTearOff();
...
abstract class $WeatherCoordCopyWith<$Res> {
  factory $WeatherCoordCopyWith(
      ...
      _$WeatherCoordCopyWithImpl<$Res>;
  $Res call({double lat, double lon});
}

/// @nodoc
class _$WeatherCoordCopyWithImpl<$Res> implements $WeatherCoordCopyWith<$Res> {
  _$WeatherCoordCopyWithImpl(this._value, this._then);

  final WeatherCoord _value;
  // ignore: unused_field
  final $Res Function(WeatherCoord) _then;
...
/// @nodoc
abstract class _$WeatherCoordCopyWith<$Res>
    implements $WeatherCoordCopyWith<$Res> {
  factory _$WeatherCoordCopyWith(
          _WeatherCoord value, $Res Function(_WeatherCoord) then) =
      __$WeatherCoordCopyWithImpl<$Res>;
  @override
  $Res call({double lat, double lon});
}

/// @nodoc
class __$WeatherCoordCopyWithImpl<$Res> extends _$WeatherCoordCopyWithImpl<$Res>
    implements _$WeatherCoordCopyWith<$Res> {
  __$WeatherCoordCopyWithImpl(
      _WeatherCoord _value, $Res Function(_WeatherCoord) _then)
      : super(_value, (v) => _then(v as _WeatherCoord));

  @override
  _WeatherCoord get _value => super._value as _WeatherCoord;
...
/// @nodoc
@JsonSerializable()
class _$_WeatherCoord implements _WeatherCoord {
  _$_WeatherCoord({required this.lat, required this.lon});
  ...
  @JsonKey(ignore: true)
  @override
  _$WeatherCoordCopyWith<_WeatherCoord> get copyWith =>
      __$WeatherCoordCopyWithImpl<_WeatherCoord>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_WeatherCoordToJson(this);
  }
}

abstract class _WeatherCoord implements WeatherCoord {
  factory _WeatherCoord({required double lat, required double lon}) =
      _$_WeatherCoord;
...
WeatherPosition _$WeatherPositionFromJson(Map<String, dynamic> json) {
  return _WeatherPosition.fromJson(json);
}

/// @nodoc
class _$WeatherPositionTearOff {
  const _$WeatherPositionTearOff();

  _WeatherPosition call(
  ...
  WeatherPosition fromJson(Map<String, Object?> json) {
    return WeatherPosition.fromJson(json);
  }
}

/// @nodoc
const $WeatherPosition = _$WeatherPositionTearOff();

/// @nodoc
mixin _$WeatherPosition {
  @JsonKey(name: 'main')
  ...
  @JsonKey(name: 'coord')
  WeatherCoord get weatherCoord => throw _privateConstructorUsedError;
  int get dt => throw _privateConstructorUsedError;
  String? get name => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $WeatherPositionCopyWith<WeatherPosition> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WeatherPositionCopyWith<$Res> {
  factory $WeatherPositionCopyWith(
          WeatherPosition value, $Res Function(WeatherPosition) then) =
      _$WeatherPositionCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: 'main') WeatherParams weatherParams,
      @JsonKey(name: 'weather') List<WeatherInfo> weatherInfo,
      @JsonKey(name: 'coord') WeatherCoord weatherCoord,
      int dt,
      String? name});

  $WeatherParamsCopyWith<$Res> get weatherParams;
  $WeatherCoordCopyWith<$Res> get weatherCoord;
}

/// @nodoc
class _$WeatherPositionCopyWithImpl<$Res>
    implements $WeatherPositionCopyWith<$Res> {
  _$WeatherPositionCopyWithImpl(this._value, this._then);

  final WeatherPosition _value;
  // ignore: unused_field
  final $Res Function(WeatherPosition) _then;

  @override
  $Res call({
    Object? weatherParams = freezed,
    Object? weatherInfo = freezed,
    Object? weatherCoord = freezed,
    Object? dt = freezed,
    Object? name = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      weatherInfo: weatherInfo == freezed
          ...
          : weatherInfo // ignore: cast_nullable_to_non_nullable
              as List<WeatherInfo>,
      weatherCoord: weatherCoord == freezed
          ? _value.weatherCoord
          : weatherCoord // ignore: cast_nullable_to_non_nullable
              as WeatherCoord,
      dt: dt == freezed
          ? _value.dt
  ...
  @override
  $WeatherCoordCopyWith<$Res> get weatherCoord {
    return $WeatherCoordCopyWith<$Res>(_value.weatherCoord, (value) {
      return _then(_value.copyWith(weatherCoord: value));
    });
  }
}

/// @nodoc
abstract class _$WeatherPositionCopyWith<$Res>
    implements $WeatherPositionCopyWith<$Res> {
  factory _$WeatherPositionCopyWith(
          _WeatherPosition value, $Res Function(_WeatherPosition) then) =
      __$WeatherPositionCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'main') WeatherParams weatherParams,
      @JsonKey(name: 'weather') List<WeatherInfo> weatherInfo,
...
/// @nodoc
class __$WeatherPositionCopyWithImpl<$Res>
    extends _$WeatherPositionCopyWithImpl<$Res>
    implements _$WeatherPositionCopyWith<$Res> {
  __$WeatherPositionCopyWithImpl(
      _WeatherPosition _value, $Res Function(_WeatherPosition) _then)
      : super(_value, (v) => _then(v as _WeatherPosition));

  @override
  _WeatherPosition get _value => super._value as _WeatherPosition;
...
/// @nodoc
@JsonSerializable()
class _$_WeatherPosition implements _WeatherPosition {
  _$_WeatherPosition(
      {@JsonKey(name: 'main') required this.weatherParams,
      @JsonKey(name: 'weather') required this.weatherInfo,
      @JsonKey(name: 'coord') required this.weatherCoord,
      required this.dt,
      this.name});

  factory _$_WeatherPosition.fromJson(Map<String, dynamic> json) =>
      _$$_WeatherPositionFromJson(json);
  ...
  @override
  String toString() {
    return 'WeatherPosition(weatherParams: $weatherParams, weatherInfo: $weatherInfo, weatherCoord: $weatherCoord, dt: $dt, name: $name)';
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(weatherCoord),
      const DeepCollectionEquality().hash(dt),
      const DeepCollectionEquality().hash(name));

  @JsonKey(ignore: true)
  @override
  _$WeatherPositionCopyWith<_WeatherPosition> get copyWith =>
      __$WeatherPositionCopyWithImpl<_WeatherPosition>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_WeatherPositionToJson(this);
  }
}

abstract class _WeatherPosition implements WeatherPosition {
  factory _WeatherPosition(
      {@JsonKey(name: 'main') required WeatherParams weatherParams,
      @JsonKey(name: 'weather') required List<WeatherInfo> weatherInfo,
      @JsonKey(name: 'coord') required WeatherCoord weatherCoord,
      required int dt,
      String? name}) = _$_WeatherPosition;

  factory _WeatherPosition.fromJson(Map<String, dynamic> json) =
      _$_WeatherPosition.fromJson;
...
class _$_Weather implements _Weather {
  ...
  @override
  String toString() {
    return 'Weather(weatherParams: $weatherParams, weatherInfo: $weatherInfo, dt: $dt, name: $name)';
  }
